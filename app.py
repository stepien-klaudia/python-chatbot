#PLIK ODPOWIADA ZA DZIAŁANIE GUI

#import bibliotek

from flask import Flask, render_template,request # działanie aplikacji
import random
...
# tworzenie routingu do strony głównej - to wyświetla się po włączeniu programu i strony
@app.route('/')
def home():
    return render_template("index.html")

# zachowanie aplikacji w przypdku, kiedy zostanie wpisane i zatwierdzone pytanie do aplikacji
@app.route('/get')
# funkcja zwracająca odpowiedź chatbota
# na początku funkcja pobiera wiadomość wprowadzoną do aplikacji
# następnie do osobnych zmiennych przypisujemy tag oraz wszystkie intents z pliku json
